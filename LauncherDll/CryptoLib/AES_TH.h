...
#define GETU32LE(plaintext) (((uint32_t)(plaintext)[0] << 0) ^ \
...
#define PUTU32LE(ciphertext, st) { (ciphertext)[0] = (uint8_t)((st) >> 0); \
						  (ciphertext)[1] = (uint8_t)((st) >> 8); \
						  (ciphertext)[2] = (uint8_t)((st) >>  16); \
						  (ciphertext)[3] = (uint8_t)((st) >>  24); }
...
static const uint8_t key_TH[16] = {
	0x44, 0x35, 0x33, 0x62, 0x59, 0x68, 0x37, 0x38,
	0x4E, 0x53, 0x64, 0x33, 0x62, 0x64, 0x32, 0x55
};
...
static const uint32_t Td0[256] =
{
	...
	0xb6e14fb6U, 0xf088ad17U, 0xc920ac66U, 0x7dce3ab4U,
...
static const uint32_t Td1[256] =
{
	...
	0x617bcb84U, 0x70d532b6U, 0x486c5c74U, 0x42d0b857U,
};
...
void AdditionalEncrypt(uint8_t* data, uint32_t size, const uint8_t* key);
...
void PrintHex(const void* data, size_t byteCount, size_t bytesPerLine = 16);
